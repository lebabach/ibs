...
public class BatchUploadLostImageTaskScheduler extends QuartzJobBean {
    private static final Logger LOG = LoggerFactory.getLogger(BatchUploadLostImageTaskScheduler.class);
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        LOG.debug("executeInternal : ", BatchUploadLostImageTaskScheduler.class);
