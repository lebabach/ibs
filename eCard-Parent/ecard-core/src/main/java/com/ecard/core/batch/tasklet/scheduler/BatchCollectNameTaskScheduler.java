 ...
 * @author vinhla
 */
public class BatchCollectNameTaskScheduler extends QuartzJobBean {
    private static final Logger LOG = LoggerFactory.getLogger(BatchCollectNameTaskScheduler.class);
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        LOG.debug("executeInternal : ", BatchCollectNameTaskScheduler.class);
