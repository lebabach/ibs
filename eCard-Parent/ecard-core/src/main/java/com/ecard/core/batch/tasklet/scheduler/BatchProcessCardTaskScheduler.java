...
public class BatchProcessCardTaskScheduler extends QuartzJobBean {
private static final Logger LOG = LoggerFactory.getLogger(BatchProcessCardTaskScheduler.class);
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        LOG.debug("executeInternal : ", BatchProcessCardTaskScheduler.class);
