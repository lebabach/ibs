...
public class CompanyCardModel {
    ...
    public CompanyCardModel(){}
    public CompanyCardModel(Integer cardId, String name, String lastName, String firstName, String nameKana, String lastNameKana, String firstNameKana,
