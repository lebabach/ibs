  ...
  <div id="container" class="container">
    ...
    <!-- <div class="manager_search_card" style="display:none">
     <div class="row" style="margin:auto;"> 
      ...
      <div class="i-checks mrg_bot5" id="managercard_3"><form> <input type="checkbox" value="" name="sch"> <input type="text" name="firstname" value="" disabled> </form> </form></div>     
      <div class="i-checks mrg_bot5" id="managercard_4"><form> <input type="checkbox" value="" name="sch"> <input type="text" name="firstname" value="" disabled> </form> </form></div>
      <div class="i-checks mrg_bot5" id="managercard_5"><form> <input type="checkbox" value="" name="sch"> <input type="text" name="firstname" value="" disabled> </form> </form></div>
     </div>
      <div class="ac">
        <p><a href="#">選択した検索条件を使用する</a></p>
        <p><a href="#">選択した検索条件を削除</a></p>
