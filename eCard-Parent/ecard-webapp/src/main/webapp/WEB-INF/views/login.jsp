...
<head profile="http://www.w3.org/2005/10/profile">
  ...
  <title><fmt:message key="webapp.title"/></title>
    ...
    <link rel="stylesheet" href="<c:url value='/assets/css/table_table.css'/>" type="text/css" media="all" />
...
<div class="middle-box text-center loginscreen animated fadeInDown">
    <div>
      <div style ="margin-left: -65px;">
        <h2 class="logo-name"><%-- <fmt:message key="webapp.name"/> --%></h2>
      </div>
      ...
      <form class="m-t" role="form" id="form_login" action="<c:url value='/j_security_check'/>" method="post">
      	
	    <div class="alert alert-danger alert-dismissable" style="display:${param.error != null? '' : 'none'}">
        ...
        <div class="form-group">
          <input type="email" name="j_username" class="form-control email-login" placeholder="<fmt:message key='login.userName.placeholder'/>" >
        </div>
        <div class="form-group">
          <input type="password" name="j_password" class="form-control password-login" placeholder="<fmt:message key='login.password.placeholder'/>" >
        </div>

        <div class="form-group">         
          <div class="i-checks"><label> <input type="checkbox" name="_spring_security_remember_me"><i></i> <fmt:message key="login.rememberMe"/> </label></div>
        </div>
        <button type="button" class="btn btn-primary block full-width m-b" id="btnLogin"><fmt:message key="login.button.login"/></button>

        <a href="<c:url value='/recoverpass'/>"><small><fmt:message key="login.forgotPassWord"/></small></a>
       </form> 
