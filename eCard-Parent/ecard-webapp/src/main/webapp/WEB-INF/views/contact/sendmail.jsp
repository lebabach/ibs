                          ...
                          <form class="form-horizontal" role="form">
                              ...
                              <div class="col-sm-4">
                               ...
                               <div class="col-sm-4 col-xs-offset-1">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="<fmt:message key="contact.sendmail.input.placeholder"/>"> 
                                            <span class="input-group-btn"> <button type="button" class="btn btn-primary"><fmt:message key="contact.sendmail.button.search"/></button></span>
                                        </div>
                                </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-4 col-xs-offset-1">          
                                      <table class="table container">
                                            <tbody>
                                                <tr id="rowData">
                                                    <td><input type="checkbox" class="i-checks i-checks-chk_all" name="chkALL" id="chkAll"> <a href="#"> Abc@gmail.com</a></td>
                                                </tr>
                                            </tbody>
                                        </table>
                              </div>
                            ...
                            <div class="form-group">        
                              <div class="col-sm-offset-1 col-sm-6">
                                <div class="checkbox">
                                  <label><input type="checkbox" class="i-checks i-checks-chk_all" name="chkALL" id="chkAll"> 全ユーザに送信</label>
                                </div>
                              </div>
                            </div>
                            <div class="form-group">        
