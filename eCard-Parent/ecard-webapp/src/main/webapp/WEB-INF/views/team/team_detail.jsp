...
<body>  
      <!-- BODY -->
      <div class="container-fluid padding-top20 bg-container height100per div-bar-top2">
        ...
        <div id="right-side" class="col-sm-12">
            ...
            <div class="row bg-white box-shadow menu-top-header col-sm-12">
                <div class="col-sm-12">
                    ...
                    <div class="float-right">
                         <h4 class="h4-header">
                        <span><button type="button" class="btn btn-primary" data-dismiss="modal" id="btnCancel" onclick="window.location.href='/ecard-webapp/teams/list'" style="float: right;">キャンセル</button></span>
                            </h4>
                    </div>
                </div>
            </div>
            ...
            <div class="row bg-white box-shadow box-marginTop5 padding-top-bottom col-sm-12">
                    <div class="container col-sm-8 col-xs-offset-2" id="data-table" style="float: none !important;margin-left: auto !important;">
                        <div class="container" style="width: 750px !important;padding-bottom: 50px;">
                          <form id="teamEditForm" class="form-horizontal" role="form">
                            <div class="form-group">
                            <div class="div-bar-top">
                                <span style="width: 100%; margin-left: 11px; text-align:left; display:block ;font-weight: bold">チーム名: ${teamVO.teamName}</span> 

                              </div>
                            </div>
                              <div class="col-sm-4 div-bar-top" style="overflow:scroll; height:200px;">
                                      <table class="table container">
                                            <tbody>
                                                ...
                                                <c:forEach var="members" items="${teamVO.userInfos}" varStatus="loop">
													<tr id="${loop.index}" role="row" class="${loop.index%2==0?'odd':'even'}">
