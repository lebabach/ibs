  ...
  <div id="right-side" class="col-sm-12">
      ...
      <div class="row bg-white box-shadow box-marginTop5 padding-top-bottom col-sm-12">
              <div class="container col-sm-8 col-xs-offset-2" id="data-table">
                  <div class="container">
                    <form class="form-horizontal" role="form" action="/ecard-webapp/teams/register" method="POST" accept-charset="UFT-8">
                      ...
                      <div class="col-sm-3">
                          ...
                          <div class="col-sm-8">
                          <input name="targetCount" class="form-control" id="tv_target" style="margin-left:11px;width:165px;" placeholder="100">
                      ...
                      <div class="form-group">        
                        <div class="col-sm-offset-2 col-sm-2">
                        	<a href='<c:url value="/teams/list"/>' class="btn btn-primary btn_cancle" role="button">キャンセル</a>
                        </div>
                        <div class="col-xs-2">
                          <button type="button" class="btn btn-primary js-23 " id="btnSaveTeamAdd">完了</button>
                      </div>
                      </div>
                    </form>
                  </div>
