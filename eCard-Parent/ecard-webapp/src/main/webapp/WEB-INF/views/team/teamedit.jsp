		...
		<div id="right-side" class="col-sm-12 div-bar-top">
					...
					<div class="col-sm-3" style="float: right; margin: 0 auto;">
						<h4 class="h4-header">
							<span><button type="submit" class="btn btn-primary"
									data-dismiss="modal" id="btnSave" style="float: right;">保存</button></span>
							<span><button type="button" class="btn btn-primary"
									data-dismiss="modal"
									onclick="window.location.href='/ecard-webapp/teams/list'"
									id="btnSaveUserProfile" style="float: right;">キャンセル</button></span>
						</h4>
					</div>
			...
			<div
				...
				<div class="container col-sm-8 col-xs-offset-2 div-bar-top2"
					id="data-table" style="width: 600px; padding-bottom: 77px;">
					<div class="container">
						<form class="form-horizontal" role="form"
							action="${teamDisplayVO.action}" id="formSubmit" method="POST">
							<div class="form-group">
								<label class="control-label col-sm-1" for="team"
									style="width: 120px">チーム名 <span style="color: red">*</span></label>
								<div class="col-sm-4">
									<input name="name" type="text" class="form-control" id="name"
										maxlength="200" size="200" value="${teamDisplayVO.name}">
									<span class='sp-name' style="color: red"></span> <input
										name="count" type="hidden" class="form-control" id="count"
										value="${teamDisplayVO.count}">
								</div>
							</div>
						</form>
					</div>
