<%@ page language="java" contentType="text/html; charset=utf-8"
  ...
  .list-group-item-title{
    background: -moz-linear-gradient(center top , #f4f4f4, #e6e6e6) repeat scroll 0 0 rgba(0, 0, 0, 0) !important;
  ...
  .list-group-item{
    ...
    <div class="row border-bottom" style="text-align:center; background: #fff;">
        <div style="display:inline-block; width:770px; margin:0 auto; padding:0;  position: relative;">
            <a href=""><img src="../assets/img/login_logo_pc.png" style="float:left; width:80px; margin:5px 0;"></a>
                            ...
                            <table class="table table-hover" id="notification">
                              ...
                              <tbody>
                                  <tr class="pointer" id="4575476666">
                                    <td  width="30%" style="vertical-align: middle"><img alt="image" style="width:100%" src="img/businesscard-1.png"></td>                  
                                    ...
                                    <td width="10%" style="vertical-align: middle"><a href="#" class=""><i class="fa fa-angle-right"></i></a></td>
                                  </tr>
                                  <tr class="pointer" id="5654686866">
                                    <td style="vertical-align: middle"><img alt="image" style="width:100%" src="img/businesscard-1.png"></td>                  
            ...
            <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0; float:right;">   
