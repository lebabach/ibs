...
<link rel="stylesheet"
	...
	media="all" />
<link rel="stylesheet"
	href="<c:url value='/assets/css/jquery.dataTables.css'/>"
	type="text/css" media="all" />
<link rel="stylesheet"
	href="<c:url value='/assets/css/slick-theme.css'/>" type="text/css"
	media="all" />
...
<script src="<c:url value='/assets/js/admin.js'/>"
	type="text/javascript"></script>
<script src="<c:url value='/assets/js/bootstrap.file-input.js'/>"
	type="text/javascript"></script>
<%-- <script src="<c:url value='/assets/js/jquery.bpopup.min.js'/>" type="text/javascript"></script> --%>
<script src="<c:url value='/assets/js/jQueryRotate.js'/>"
	type="text/javascript"></script>
<script
...
<body>
	...
	<div id="loadingProgress" class="loading-progress"
		...
		<div class="progress-inner">
			<img class="loader"
				src="<c:url value='/assets/img/ajax-loader.gif'/>" />
		</div>
	</div>
</body>
</html>
