...
<div id="center-side" class="col-sm-12">
	...
	<div class="row bg-white box-shadow box-marginTop5 padding-top-bottom">
		<form class="form-horizontal" id="registerUserProfileForm"
			action="/ecard-webapp/operators/register" , method="POST"
			accept-charset="UFT-8" autocomplete="off">
			<div class="col-sm-12">
				<div class="col-sm-6">
					<!-- BEGIN FORM -->
					...
					<fieldset>
						<div class="form-group">
							<label for="title-of-honour" class="control-label col-xs-2"><fmt:message
									key="operator.email" /><span class="error-color">*</span></label>
							<div class="col-xs-4">
								<input name="email" type="text" class="form-control" id="email"
									size="40" autocomplete="off"> <span
									class='sp-email-format' style="color: red"></span>
							</div>
						</div>
						<%-- <div class="form-group">
					...
					<div class="form-group">
						<label for="groupComposition" class="control-label col-xs-2"><fmt:message
								key="operator.role.service" /><span class="error-color">*</span></label>
						<div class="col-xs-4">
							<form>
								<c:if
									...
									<select id="roleId" class="form-control" disabled>
					...
					<div class="form-group">
						<label for="groupComposition" class="control-label col-xs-2"><fmt:message
								key="operator.role.admin" /><span class="error-color">*</span></label>
						<div class="col-xs-4">
							<form>
							...
							<input type="hidden" class="role-admin" name="roleAdminId"
								value='1' /> <span class='sp-roleId' style="color: red"></span>
						</div>
					</div>
							...
							<ul class="list-li">
								<div style="width: 274px">
									<li><input icheck type="checkbox" class="i-checks"
										name="sfManualLinkFlg" id="all_card" value="1" /> <a href="#"><fmt:message
												key="operator.salesforce" /></a></li>
								</div>
							</ul>
						</div>
					</div>
						...
						<div class="col-sm-4">
							<div class="input-group date">
								...
								<input type="text" id="datepicker" class="form-control"
									name="useDateShow"
									value='<fmt:formatDate value="${operatoredit.user.useDate}" pattern="yyyy年MM月dd日" />'>
								<input type="hidden" id="useDate" class="useDate" name="useDate"
									value='<fmt:formatDate value="${operatoredit.user.useDate}" pattern="yyyy年MM月dd日"/>' />
					...
					<div class="row form-group">
						...
						<div class="col-sm-4">
							<div class="input-group date">
								<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
								<input type="text" id="datepickerEndDate" class="form-control"
									name="endDateShow"
									value='<fmt:formatDate value="${operatoredit.user.endDate}" pattern="yyyy年MM月dd日" />'>
				...
				<div class="col-sm-6">
					<fieldset>
						...
						<div class="form-group">
							<label for="middlename" class="control-label col-xs-4"><fmt:message
									key="operator.companyname" /><span style="color: red">*</span></label>
							<div class="col-xs-6">
								<form:select name="groupCompanyId" class="form-control"
									path="operatorregisterData" id="companyId">
									<form:options
										items="${operatorregisterData.get('listCompany')}" />
								</form:select>
								<span class='sp-companyName' style="color: red"></span> <input
									type="hidden" name="groupCompanyId" id="groupCompanyId"
									value=""> <input type="hidden" name="companyName"
									id="companyName" value="">
							</div>
						</div>
						<div class="form-group">
							<label for="middlename" class="control-label col-xs-4"><fmt:message
									key="operator.departmentName" /><span style="color: red">*</span></label>
							<div class="col-xs-6">
								...
								<input type="text" name="departmentName" id="departmentName"
									class="form-control" value="" size="40"> <span
									class='sp-departmentName' style="color: red"></span>
							</div>
						</div>
						<div class="form-group">
							<label for="middlename" class="control-label col-xs-4"><fmt:message
									key="operator.positionName" /></label>
							<div class="col-xs-6">
								<input name="positionName" type="text" class="form-control"
									id="positionName" size="40">
							</div>
						</div>
						<div class="form-group">
							<hr align="left" style="margin-left: 16px; width: 737px;" />
						</div>
						<div class="form-group">
							<label for="title-of-honour" class="control-label col-xs-4"><fmt:message
									key="operator.lastname" /><span class="error-color">*</span></label>
							<div class="col-xs-6">
								<input name="lastName" type="text" class="form-control"
									id="lastName" size="40"> <span class='sp-lastName'
									style="color: red"></span>
							</div>
						</div>
						<div class="form-group">
							<label for="lastName" class="control-label col-xs-4"><fmt:message
									key="operator.firstname" /><span class="error-color">*</span></label>
							<div class="col-xs-6">
								<input name="firstName" type="text" class="form-control"
									id="firstName" size="40"> <span class='sp-firstName'
									style="color: red"></span>
							</div>
						</div>
						<div class="form-group">
							<label for="middlename" class="control-label col-xs-4"><fmt:message
									key="operator.lastnamekana" /><span class="error-color">*</span></label>
							<div class="col-xs-6">
								<input name="lastNameKana" type="text" class="form-control"
									id="lastNameKana" size="40"> <span
									class='sp-lastNameKana' style="color: red"></span>
							</div>
						</div>
						<div class="form-group">
							<label for="lastname-furigana" class="control-label col-xs-4"><fmt:message
									key="operator.firstnamekana" /><span class="error-color">*</span></label>
							<div class="col-xs-6">
								<input name="firstNameKana" type="text" class="form-control"
									id="firstNameKana" size="40"> <span
									class='sp-firstNameKana' style="color: red"></span>
							</div>
						</div>
