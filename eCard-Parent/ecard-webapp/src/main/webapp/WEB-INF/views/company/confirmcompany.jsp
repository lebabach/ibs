				...
				<form class="form-horizontal" role="form">
					<div class="form-group">
						<div class="col-sm-2 col-sm-offset-4">
							...
							<label class="control-label" for="date" style="display: block;">会社名
							</label> <label class="control-label" for="name"
								style="line-height: 40px;">グループ参加日</label>
						</div>
						...
						<div class="col-sm-1 company-name">
							...
							<h4 style="width: 100%; display: block;">
								<c:out
									value="${groupCompanyDepartmentVO.groupCompanyInfo.groupCompanyName}" />
							</h4>
							<h4 style="margin-top: 15px; line-height: 30px;">
								<fmt:formatDate
									value="${groupCompanyDepartmentVO.groupCompanyInfo.createDate}"
									pattern="yyyy年 MM月dd日" />
							</h4>
						</div>
					</div>
