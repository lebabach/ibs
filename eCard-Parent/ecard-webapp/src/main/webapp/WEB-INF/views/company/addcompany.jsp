           ...
           <div class="row bg-white box-shadow menu-top-header col-sm-12">
            ...
            <div class="row bg-white box-shadow box-marginTop5 padding-top-bottom col-sm-12">
                    <!-- <div class="col-sm-8 col-xs-offset-2" id="data-table"> -->
                        <div class="container">
                          <form class="form-horizontal" role="form" id= "addCompany" method="POST" action="/ecard-webapp/companies/registerCompany">
                            <div class="form-group">
                              <label class="control-label col-sm-3 col-xs-offset-2" for="name">会社名</label>
                              <div class="col-sm-5">
                                <input type="text" class="form-control" id="company-name" name="groupCompanyName">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-5">
                                 <div class="input-group date">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control create-date" name="createDate" value="">
                                </div>
                              </div>
                            </div>
