        ...
        <div id="right-side" class="col-sm-12">
            ...
            <div class="row bg-white box-shadow box-marginTop5 padding-top-bottom col-sm-12">
                    <!-- <div class="col-sm-8 col-xs-offset-2" id="data-table"> -->
                        <div class="container">
                          <form class="form-horizontal" role="form"  id = "editCompanyForm"action="/ecard-webapp/companies/editCompany" method="POST" accept-charset="UFT-8">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-5">
                                <input type="text" class="form-control" id="company-name" name="groupCompanyName" value= '<c:out value="${groupCompanyDepartmentVO.groupCompanyInfo.groupCompanyName}" />' >
                                <input type="hidden" class="form-control" id="company-id" name="groupCompanyId" value= '<c:out value="${groupCompanyDepartmentVO.groupCompanyInfo.groupCompanyId}" />'  maxlength="3" size="3">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group date">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control create-date" name="createDate" value= '<fmt:formatDate value="${groupCompanyDepartmentVO.groupCompanyInfo.createDate}" pattern="yyyy年 MM月dd日" />'>
                                </div>
                              </div>
                            </div>
