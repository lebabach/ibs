...
<link rel="stylesheet" href="<c:url value='/assets/css/style_scan.css'/>" type="text/css" media="all" />
...
<body>
    <div class="container-fluid padding-top20 bg-container height100per">
                                ...
                                <div id="inner">
                                    <div class="box-1">
                                        ...
                                        <div class="content-box-1">
                                            <div class="ch-scan">
                                                <input type="file" name="files[]" class="submit-1" id="files" multiple title="フォルダ選択" style="left: -196.859375px; top: 3px;">
                                            </div>
                                            ...
                                            <div class="box-2">
                                                ...
                                                <div class="content-box-2">
                                                    ...
                                                    <div class="ch-list-but">
                                                        ...
                                                        <input id="btnDelete" class="btn btn-default" type="button" value="削除" style="color: #666666; width:100px">
                                                        <input id="btnCheckedCheckBox" class="btn btn-default" type="button" value="全て選択" style="color: #666666; width:100px">
                                                        <input id="btnUnCheckedCheckBox" class="btn btn-default" type="button" value="全て選択解除" style="color: #666666; width:100px">
                                                         <input type="hidden" name="rote" id="rote-image" value="">
                                                    </div>
                                                    <div id="loading" style= "display:none; z-index: 1000;position: fixed;top: 288px; margin: 0 auto;left: 796px">
													  <p><img src="../assets/img/loader.gif" height="200" width="235" style="border-radius: 238px;opacity:0.5;"/></p>
													</div>
                                                </div>    
                                            </div>
                                            <div class="btn-footer col-sm-12">
                                                <div class="btn-left col-sm-2" style="float:left;text-align:left;padding-left:0;">
                                                     <button type="button" id="btnBackToManageCard" class="btn btn-primary btn_process  ">閉じる</button>
                                                </div>
                                                <div class="btn-content col-sm-8" style="text-align:left;">
                                                      <button type="button" class="btn btn-primary btn_search " data-toggle="modal" >利用者検索</button>
                                                      <input type="hidden" name="userId" class = "user_id" value="">
                                                      <input type="text" class="form-control" id="exampleInputName2" placeholder="（利用者の所属・名前が入る）" style="width:300px;display:inline-block;" disabled>
                                                </div>
                                                <div class="btn-right col-sm-2" style="float:right;padding-right:0;text-align:right;">
                                                     <button type="button" class="btn btn-primary btn_process btn_register_card ">サーバーに送信</button>
                                                </div>
                                            </div>
                                        </div>    
                                    </div>
        ...
        <div class="modal fade modelAdd" id="modelAddTag" role="dialog">
            <div class="modal-dialog">
              ...
              <div class="modal-content" >
                <div class="modal-header" style ="background-color:#1ab394;text-align: left; ">
			        <h4 class="modal-title" style ="text-align: left;"><fmt:message key="popup.heading"/></h4>
			     </div>
                <div class="modal-body">
	                    <h4 class="modal-title"> 
	                        <div class="input-group">
	                            <input type="text" class="form-control seach_card" value="${operatorSearchVO.criteriaSearch}"   name="criteriaSearch" placeholder="<fmt:message key="operator.list.placeholder"/>"> 
	                            <span class="input-group-btn"> <button type="submit" class="btn btn-primary btn-sm btn_search"><fmt:message key = "operator.list.search" /></button></span>
	                        </div>
	                    </h4>
                            ...
                            <div class="col-sm-12">
                              <!--   <div class="title_card">
                                ...
                                <div class="row" id="data-table">
                                        <div class="ibox-content" style="height:500px;overflow: overlay;">
        ...
        </div> <!-- END MODEL ADD TAG -->
        <!-- bPopUp -->
        <div id="element_to_pop_up" style = "display:none;">Please choose user need upload image</div>
      </div>
