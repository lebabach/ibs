		...
		<div class="row bg-white box-shadow menu-top-header">
			<div class="col-sm-12">
				<div class="float-left">
					<h4 class="h4-header"><fmt:message key="log.header"/></h4>
				</div>
                        ...
                        <div class="wrapper-log">
                            ...
                            <div class="row clearfix search-log header-content">
                                <div class="col-md-6 col-md-offset-3">
                                    <div class="input-group search-log-input-text">
                                        <input type="text" class="form-control search_log" id = "criteriaSearch" name="criteriaSearch" placeholder="Enter content search......"> 
                                        <span class="input-group-btn"> <button type="submit" class="btn btn-primary btn_search" ><fmt:message key = "operator.list.search" /></button></span>
                                    </div>
                                </div>
                            </div>
                            </form>
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6 col-md-offset-3 column">
                                    <div class="form-group search-log-input-textarea" style="height:500px;overflow: overlay;">
                                      <table class="table">
                                             <thead>
		                                      ...
		                                      <tbody class="content_user">
		                                                <c:forEach var="listlog" items="${listLogEventVo}">
															  <tr>
																<td><fmt:formatDate value='${listlog.actionDate}' pattern="yyyy年 MM月dd日" /></td>
																<td class ="content_log"><c:out value="${listlog.actionMessage}" /></td>
